...
export class DegreeLevelServiceImpl implements DegreeLevelService {
  ...
  public async createDegreeLevel(degreeLevelModel: DegreeLevelModel): Promise<DegreeLevelModel> {
    await this.degreeLevelRepository.createDegreeLevel(degreeLevelModel);
